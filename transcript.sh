...
say -o "008-round1-desc" "The best part is, not only do you score points for guessing the answer correctly, but also when people vote for yours." &
say -o "009-round1-desc" "So be as deceptive and as convincing as you can. Okay. Are you ready for the question? Here it comes."  &&
#say -o "010-round1-desc" "now" &&
