...
say -o "guessed-appearance-desc-5" "But the best part is, not only do you score points for guessing the answer correctly, but also when people vote for your answer." &
...
say -o "excerpt-opinions-desc-3" "The answer should by no means be serious - wikipedia articles are edited to say stupid stuff all the time"  &
